                            ...
                            {!showClosureForm ? (
                                <>
                                    {canShare && (
                                        <button
                                            onClick={handleShare}
                                            className="px-5 py-2 text-xs font-black tracking-widest text-indigo-600 dark:text-indigo-400 uppercase transition-all bg-indigo-50 dark:bg-indigo-900/30 border-2 border-indigo-100 dark:border-indigo-800/50 rounded-xl hover:bg-indigo-100 dark:hover:bg-indigo-800/40 shadow-sm flex items-center gap-2 group flex-1 sm:flex-none justify-center"
                                            title="Copiar enlace del reporte"
                                        >
                                            {copied ? (
