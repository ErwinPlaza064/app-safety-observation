...
<body class="font-sans antialiased" style="background: linear-gradient(to bottom right, #eff6ff, #eef2ff);">
    <div class="min-h-screen flex items-center justify-center px-4 py-8">
        <div class="max-w-lg w-full text-center">
            ...
            <div class="mb-8">
                <svg class="mx-auto h-32 w-32 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p class="text-gray-600 mb-8 px-2">
                Tu sesión ha expirado por inactividad. Por favor, recarga la página e intenta nuevamente.
            </p>

            <div class="bg-white rounded-lg p-6 mb-8 shadow-md mx-2">
                <div class="flex items-start">
                    <svg class="h-6 w-6 text-primary mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="text-left">
                        ...
                        <p class="text-sm text-gray-600">
                            Las sesiones expiran automáticamente después de cierto tiempo de inactividad para proteger
                            tu información.
                        </p>
                    </div>
                </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center px-4">
                <button onclick="window.location.reload()"
                    class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-primary transition-colors">
